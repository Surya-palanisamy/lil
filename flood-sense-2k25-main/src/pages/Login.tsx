...
export default function Login() {
  ...
  useEffect(() => {
    const savedEmail = localStorage.getItem("floodSenseEmail")
    if (savedEmail) {
      setEmail(savedEmail)
      setRememberMe(true)
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">FloodSense</h2>
        <p className="mt-2 text-center text-sm text-gray-600">Disaster Management & Response System</p>
      </div>
